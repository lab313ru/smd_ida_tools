...
static int idaapi read_registers(thid_t tid, int clsmask, regval_t *values)
{
    if (clsmask & RC_GENERAL)
    {
        ...
        values[R_A0].ival = main68k_context.areg[R_A0 - R_A0] & 0xFFFFFF;
        values[R_A1].ival = main68k_context.areg[R_A1 - R_A0] & 0xFFFFFF;
        values[R_A2].ival = main68k_context.areg[R_A2 - R_A0] & 0xFFFFFF;
        values[R_A3].ival = main68k_context.areg[R_A3 - R_A0] & 0xFFFFFF;
        values[R_A4].ival = main68k_context.areg[R_A4 - R_A0] & 0xFFFFFF;
        values[R_A5].ival = main68k_context.areg[R_A5 - R_A0] & 0xFFFFFF;
        values[R_A6].ival = main68k_context.areg[R_A6 - R_A0] & 0xFFFFFF;
...
static int idaapi write_register(thid_t tid, int regidx, const regval_t *value)
{
    ...
    {
        main68k_context.areg[regidx - R_A0] = (uint32)value->ival & 0xFFFFFF;
    }
    else if (regidx == R_PC)
    {
